        ...
        <div className='content-wrapp'>
            <div className='content-body'>
                <div className='content-text'>
                    <p>
                        {/* <p>ClevrFit — это не просто приложение, а твой личный помощник</p>
                        <p>в мире фитнеса. Не откладывай на завтра — начни тренироваться</p>
                        <p>уже сегодня!</p> */}
                        {'ClevrFit — это не просто приложение, а твой личный помощник'} {'в мире фитнеса. Не откладывай на завтра — начни тренироваться'} {'уже сегодня!'}
                    </p> 
                </div>
            </div>
